...
void anda(uint32_t comando) {
  if (comando == 0) {
    ...
    softPwmWrite(2, 0);
    softPwmWrite(3, 0);
  } else if (comando == 2) { //giro180 esquerda
    softPwmWrite(0, 0);
    softPwmWrite(1, 70);
    softPwmWrite(2, 0);
    softPwmWrite(3, 70);
  } else if (comando == 3) { //giro180 direita
    softPwmWrite(0, 70);
    softPwmWrite(1, 0);
    softPwmWrite(2, 70);
    softPwmWrite(3, 0);
  } else if (comando == 4) { //frente
    softPwmWrite(0, 100);
    softPwmWrite(1, 0);
    softPwmWrite(2, 0);
    softPwmWrite(3, 100);
  } else if (comando == 5) { //frente
    softPwmWrite(0, 100);
    softPwmWrite(1, 0);
    softPwmWrite(2, 0);
    softPwmWrite(3, 100);
  } else if (comando == 6) { //giro90 esquerda
    softPwmWrite(0, 0);
    softPwmWrite(1, 70);
    softPwmWrite(2, 0);
    softPwmWrite(3, 70);
  } else if (comando == 7) { //giro90 esquerda
    softPwmWrite(0, 0);
    softPwmWrite(1, 70);
    softPwmWrite(2, 0);
    softPwmWrite(3, 70);
  } else if (comando == 8) { //giro90 direita
    softPwmWrite(0, 70);
    softPwmWrite(1, 0);
    softPwmWrite(2, 70);
    softPwmWrite(3, 0);
  } else if (comando == 9) { //giro90 direita
    softPwmWrite(0, 70);
    softPwmWrite(1, 0);
    softPwmWrite(2, 70);
    softPwmWrite(3, 0);
